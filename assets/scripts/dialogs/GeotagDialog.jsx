...
It handles setting, displaying, and clearing location information associated with a 'street'
 */
function GeotagDialog () {
  ...
  const handleMapClick = (event) => {
    // for later, lets talk about whether this actually best for UX vs other patterns
